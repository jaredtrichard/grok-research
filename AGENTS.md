...
- Book schema and intake: `skills/project-management/SKILL.md`. Adversarial review targets a research view, not a git branch: `skills/adversarial-review/SKILL.md`. Do not create `book.db` on this Mac.
